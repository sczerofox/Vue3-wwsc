...
const updateCartStore = async () => {
  const i = cartStore.cartList;
  console.log(JSON.stringify(i));
  // await cartStore.updateCart(i);
  ...
  <div class="xtx-cart-page">
    <div class="container m-top-20">
      <div class="cart">
        <table>
          ...
          <tr v-for="i in cartStore.cartList" :key="i.id">
            ...
            <td class="tc">
              <p class="f16 red" @change="cartStore.updateCart(i)">&yen;{{ (i.price * i.count).toFixed(2) }}</p>
            </td>
            <td class="tc">
              <p>
      ...
      <div class="action">
        ...
        <div class="total">
          <el-button size="large" type="primary" @click="updateCartStore" >下单结算</el-button>
        </div>
      </div>
    </div>
  </div>
